...
SD_ROOT = "/sdcard"
SNAPSHOT_FILE = SD_ROOT + "/snapshot.bin"
...
CAPTURE_FRAMESIZE = sensor.WQXGA2  # Maximum resolution
EXPECTED_WIDTH = 2592
EXPECTED_HEIGHT = 1944
EXPECTED_SIZE = EXPECTED_WIDTH * EXPECTED_HEIGHT  # 5,038,848 bytes (~5MB)
